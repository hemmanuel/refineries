              ...
              {!estimate ? (
                ...
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-400 mt-4 justify-center bg-gray-50 py-2 rounded">
                    ...
                    <span>AI Confidence Score: {(estimate.confidence * 100).toFixed(0)}%</span>
                  </div>
                  
                  {estimate.reasoning && (
                    <div className="mt-4 p-3 bg-gray-50 rounded text-xs text-gray-500 italic border border-gray-100">
                      "{estimate.reasoning}"
                    </div>
                  )}
                </div>
